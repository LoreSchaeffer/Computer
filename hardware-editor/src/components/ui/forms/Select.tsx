...
const Select = ({
    ...
    return (
        <div className={clsx(styles.selectContainer, className)} style={style} ref={containerRef}>
            <div
                className={clsx(styles.trigger, styles[background], isOpen && styles.open, error && styles.error, disabled && styles.disabled)}
            ...
            >
                ...
                <span className={styles.chevron}><FaChevronDown/></span>
            </div>
